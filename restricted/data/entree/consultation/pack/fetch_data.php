...
<link rel="stylesheet" href="../../../styles/article.css">
  <?php
  $sql = "select * from vignette where not libelle='stock initial' and categorieID=$categorieID and programmeID=2 and typeID=1 and exercice='$date' order by vignetteID";
