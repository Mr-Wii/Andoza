...
$sql = "insert into vignette (exercice,date,valeurE,num_conv,observation,libelle,categorieID,programmeID,typeID,frID) values ('$exercice', '$DATE','$MONTANT','$numero','$OBSERVATION','$LIBELLE','$categorie','2','1','$frID')";
...
if (isset($_POST['submit2']))
{
  ...
  $sql = "insert into vignette (exercice,date,valeurEE,num_conv,observation,libelle,categorieID,programmeID,typeID,frID) values ('$exercice', '$DATE','$MONTANT','$numero','$OBSERVATION','$LIBELLE','$categorie','2','1','$frID')";
