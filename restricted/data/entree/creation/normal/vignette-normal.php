...
<HTML>
  <head>
    <meta charset="utf-8">
    <title>BON D'ENTREE VIGNETTES</title>
  ...
  <body>
    ...
    <li>
      <div class="ayy">
        ...
        <div class="ayyctn">
            <a class="active2" href="vignette-normal.php">Vignette Normal</a>
            <a href="../pack/vignette-pack">Vignette Pacczoo</a>
        </div>
      </div>
      </li>
...
<a href="../../../consultation/consultation.php" id="projects">Consultation</a>
    ...
    <h2 align="center"class="h2">BON D'ENTREE VIGNETTES</h2>
    <br>
