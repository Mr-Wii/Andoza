  ...
  <body>
    ...
    <li>
      <div class="ayy">
        ...
        <div class="ayyctn">
            <a href="../normal/consultation.php">Normal</a>
            <a class="active2" href="../consultation.php">Pacczoo</a>
            <a href="../../both/consultation.php">Normal & Pacczoo</a>
        </div>
      </div>
      </li>
    <li>  <a href="consultation.php" class="active1">Fin d'exercice</a></li>
...
<?php } elseif(isset($_SESSION['user_id']) && ($_SESSION['user_level']) && ($_SESSION['user_level']=="normal")) { ?>
  <html>
    ...
    <body>
      ...
      <li>
        ...
        <li><a href="consultation.php">Fin d'exercice</a></li>
              <li><a href="javascript:window.print()">Imprimer</a></li>
      <li style="float:right"><a class="active" href="about.asp">About</a></li>
      </ul>
      <link rel="stylesheet" href="../../../../styles/side.css">
  ...
  <a href="../../consultation.php" id="projects">Consultation</a>
      ...
      <center>
            <div>
        <h1>FICHE INDIVIDUEL <script>document.write(new Date().getFullYear())</script><h1>
