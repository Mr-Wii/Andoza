...
?>
  ...
  $sum = "select sum(valeurE) as total1 from vignette where not libelle='stock initial' and programmeID=2 and categorieID='$categorieID' and exercice='$date' and nom_prenom LIKE '%$nm%'";
  $tot = mysqli_query($connect, $sum);
  $sum1 = "SELECT SUM(valeurS) AS Total2 from vignette where categorieID='$categorieID' and programmeID=2 and exercice='$date' and nom_prenom LIKE '%$nm%'";
