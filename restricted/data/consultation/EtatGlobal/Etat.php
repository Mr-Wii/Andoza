...
$sql = "select observation,vignette.categorieID,code,type,sum(valeurE)as entree,sum(valeurS)as valeurS,sum(valeurE)-sum(valeurS)as valeurD from vignette inner join categorie on vignette.categorieID=categorie.categorieID where exercice='$date' group by code,type,categorieid,observation";
...
<html>
  ...
  <li><a href="../consult.php">Fiche Individuel</a></li>
    <li><a href="etatprint">Fin d'exercice</a></li>
    ...
    <center>
      ...
      <table id="hor-minimalist-b">
        <tr>
            ...
            <th>Sorties<br><?= $date; ?></th>
			      <th>Stock Disponible<br><?= $date?></th>
