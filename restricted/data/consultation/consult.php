...
<HTML>
  ...
  <body>
    <ul>
      ...
      <li><a class="active1"  href="consult.php">Fiche Individuel</a></li>
...
<a href="consultation.php" id="projects">Consultation</a>
    ...
    <center>
      ...
      <br>
    <form action="normal/consultation.php" method="post">
        <button class="dropdown" type="submit"><span>NORMAL</span></button>
    </form>
    <br>
    <form action="pack/consultation.php" method="post">
      <button class="dropdown" type="submit"><span>PACCZOO</span></button>
    </form>
    <br>
    <form action="both/consultation.php" method="post">
      <button class="dropdown" type="submit"><span>NORMAL & PACZOO</span></button>
    </form>
    </center>
    <div class="terms">
