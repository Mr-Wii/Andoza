...
<link rel="stylesheet" href="table.css" type="text/css">
  <?php
  $sql = "select * from vignette where categorieID=$categorieID and programmeID=1 and typeID=2 and exercice='$date' order by numero_E_S";
  ...
  <?php } elseif(isset($_SESSION['user_id']) && ($_SESSION['user_level']) && ($_SESSION['user_level']=="normal")) { ?>
    <link rel="stylesheet" href="table.css" type="text/css">
      <?php
      $sql = "select * from vignette where categorieID=$categorieID and programmeID=1 and typeID=2 and exercice='$date'";
      $result = mysqli_query($connect, $sql);
      ?>
      <table id="hor-minimalist-b">
        <thead>
