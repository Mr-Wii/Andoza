<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $obs=$_POST['newobs'];
        $lbl=$_POST['newlbl'];
        $sql = "update vignette set exercice='$exercice',num_conv='$numc',date='$date',valeurS='$mt',valeurSE='$mt2',numero_E_S='$num',observation='$obs',libelle='$lbl',frID='$categorie' where vignetteID='$id'";
...
<td><input type="text"  name="newmt" value="<?php  echo $sorties['valeurS']; ?>" ></td>
<td><input type="text"  name="newmt2" value="<?php  echo $sorties['valeurSE']; ?>" ></td>
