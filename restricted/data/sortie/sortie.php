...
<a class="active1" href="sortie.php" id="blog">Sorties</a>
<a href="../consultation/consultation.php" id="projects">Consultation</a>
    ...
    <form action="new.php" method="post">
        <button class="dropdown" type="submit"><span>Enregistrement des sorties</span></button>
    </form>
    <br>
    <form action="consult.php" method="post">
      <button class="dropdown" type="submit"><span>Consultation des sorties</span></button>
    </form>
    </center>
    <div class="terms">
