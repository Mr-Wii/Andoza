...
$sql = "insert into vignette (exercice,date,valeurS,numero_E_S,observation,libelle,categorieID,programmeID,typeID,frID) values ('$exercice', '$DATE','$MONTANT','$numero','$OBSERVATION','$LIBELLE','$categorie','2','2','$frID')";
...
if (isset($_POST['submit2']))
{
  ...
  $sql = "insert into vignette (exercice,date,valeurSE,numero_E_S,observation,libelle,categorieID,programmeID,typeID,frID) values ('$exercice', '$DATE','$MONTANT','$numero','$OBSERVATION','$LIBELLE','$categorie','2','2','$frID')";
